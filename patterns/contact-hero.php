...
?>
<!-- wp:cover {"url":"<?php echo $img; ?>","dimRatio":72,"customOverlayColor":"#000e1c","isUserOverlayColor":true,"minHeight":495,"minHeightUnit":"px","align":"full","contentPosition":"left center","className":"up-hero up-hero--short up-hero--contact","layout":{"type":"default"}} -->
<div class="wp-block-cover alignfull up-hero has-custom-content-position is-position-left-center up-hero--short up-hero--contact" style="min-height:495px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-70 has-background-dim" style="background-color:#000e1c"></span><img class="wp-block-cover__image-background" alt="" src="<?php echo $img; ?>" data-object-fit="cover"/><div class="wp-block-cover__inner-container">
