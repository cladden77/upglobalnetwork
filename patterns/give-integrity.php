...
<div class="wp-block-group alignfull up-integrity" id="give">
	...
	<!-- /wp:paragraph -->
	<!-- wp:group {"className":"up-integrity__stats","layout":{"type":"default"}} -->
	<div class="wp-block-group up-integrity__stats">
		<!-- wp:group {"layout":{"type":"constrained"}} -->
		<div class="wp-block-group">
			<!-- wp:heading {"level":3} -->
			<h3 class="wp-block-heading">92%</h3>
			<!-- /wp:heading -->
			<!-- wp:paragraph -->
			<p>Field Impact</p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-group">
			<!-- wp:heading {"level":3} -->
			<h3 class="wp-block-heading">08%</h3>
			<!-- /wp:heading -->
			<!-- wp:paragraph -->
			<p>Admin &amp; Growth</p>
			<!-- /wp:paragraph -->
